...
public class WeChatPayController {
    ...
    public String get_prepay_info(HttpServletRequest request, Model model) {
        ...
        String trade_key_info = "trade_key_info:name,fee,balance";
        String total_fee = parameterMap.get("amount")[0];
        String out_trade_no = "WX_CHARGE_" + (new RandomMaker().create(RandomMaker.TYPE_TIMENUMBER, 4));
